...
describe User do
  ...
  it "should create a new instance given valid attributes do" do
    User.create!(@attr)
  end
  ...
  describe "micropost associations" do
    ...
    it "should have the rightmicroposts int he right order" do
    ...
    describe "status feed" do
      ...
      it "should include the microposts of follwed users" do
